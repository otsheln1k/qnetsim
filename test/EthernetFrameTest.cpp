...
void EthernetFrameTest::testCrc32Dumb() {
...
void EthernetFrameTest::testCrc32Dumb_data() {
...
void EthernetFrameTest::testDotQTag() {
...
void EthernetFrameTest::testDotQTag_data() {
...
void EthernetFrameTest::testEthernetFrame() {
    QFETCH(uint64_t, src);
    QFETCH(uint64_t, dst);
...
void EthernetFrameTest::testEthernetFrame_data() {
...
void EthernetFrameTest::testCalculateChecksum() {
...
void EthernetFrameTest::testCalculateChecksum_data() {
...
void EthernetFrameTest::testFakeChecksum() {
    EthernetFrame frame {};
    frame.setSrcAddr(0x101010101010);
    frame.setDstAddr(0x202020202020);
    frame.setEtherType(ETHERTYPE_ECTP);
