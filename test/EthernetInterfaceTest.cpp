...
void EthernetInterfaceTest::testConnectDisconnect() {
...
void EthernetInterfaceTest::testMultipleFrames() {
    EthernetInterface *is[2] = {
        new EthernetInterface {},
        new EthernetInterface {},
    };
...
void EthernetInterfaceTest::testHalting() {
    QFETCH(int, n_hops);
...
void EthernetInterfaceTest::testHalting_data() {
